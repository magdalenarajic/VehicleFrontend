...
const MakeList = () => {
  ...
  <ul className="pagination justify-content-end">
    ...
    <li class="btn" variant="outline-dark"><button> 1 </button></li>
    <li class="btn" variant="outline-dark"><button> 2 </button></li>
    <li class="btn" variant="outline-dark"><button> 3 </button></li>
    <li class="btn" variant="outline-dark"><button> Next </button></li>
  </ul>
</nav>
            </Col>
              </Col>
