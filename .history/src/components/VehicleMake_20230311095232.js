...
import { Container, Table, Col, Row, CloseButton, ListGroup, ListGroupItem,  } from "react-bootstrap";
...
const MakeList = () => {
  ...
  <ul className="pagination justify-content-end">
    <li className="btn btn-secondary" variant="outline-dark"> <button> Prev </button> </li>
    <li className="btn" variant="outline-dark"><button> 1 </button></li>
    <li className="btn" variant="outline-dark"><button> 2 </button></li>
    <li className="btn" variant="outline-dark"><button> 3 </button></li>
    <li className="btn" variant="outline-dark"><button> Next </button></li>
  </ul>
</nav>
            </Col>
              </Col>
